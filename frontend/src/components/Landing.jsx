    ...
    <div id="landing" className="lanbody h-screen">
      <div className="flex justify-center lg:pt-32 md:pt-16 items-center pt-72">
        <motion.img
          src={catalysisImg}
          alt="Logo"
          animate={{ width: 650, height: 400 }}
          className="w-20 h-20"
        />
              
      </div>
      <div className="lg:pr-[20%] md:pr-[20%] pr-0">
        <p className="text-[#8ac4e2] font-semibold lg:text-right lg:text-4xl md:text-right md:text-3xl text-center text-2xl">
          Technology at its peak!!
        </p>
      </div>
      <div className="pt-16">
        <p className="text-[#E5F2FF] font-semibold text-center lg:text-5xl md:text-3xl text-3xl">
